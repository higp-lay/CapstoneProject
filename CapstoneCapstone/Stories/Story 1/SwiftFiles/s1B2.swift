...
struct s1B2: View {
    ...
    static var initialDialogues: [DialogueItem] {
        [
            ...
            DialogueItem(
                text: "Her gaze was steady, compassionate. 'It's not wrong,' she replied softly. 'You're not the only one. It's natural to seek peace for yourself and your family when you're in pain.'",
                systemImage: "person.fill",
                speaker: "Nurse"
            ),
            DialogueItem(
    ...
    var choices: [Choice] {
        [
            Choice(
                ...
                consequence: "You've chosen to end your suffering through euthanasia.",
                systemImage: "peacesign",
                unlocksScenario: "s1B2a"
            ),
            Choice(
                text: "Refuse euthanasia",
                consequence: "You've decided to continue your natural life journey.",
