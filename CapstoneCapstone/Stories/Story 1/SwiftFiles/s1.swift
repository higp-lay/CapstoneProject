...
struct s1: View {
    ...
    static var initialDialogues: [DialogueItem] {
        [
            ...
            DialogueItem(
                text: "'I'm afraid the results aren't what we had hoped for,' he said softly, the disappointment palpable in his tone and in the air. 'The chemotherapy isn't having the desired effect.' It was as if God had decided to strip away all the blessings slowly bestowed upon me.",
                systemImage: "person.fill",
                speaker: "You"
            ),
            DialogueItem(
    ...
    var choices: [Choice] {
        [
            Choice(
                text: "New drug treatment (70% success rate)",
                consequence: "You've chosen to proceed with the experimental treatment.",
                systemImage: "pills.fill",
                unlocksScenario: "s1A"
            ),
            Choice(
                text: "Traditional chemotherapy (20% success rate)",
                consequence: "You've decided to continue with traditional chemotherapy.",
