...
struct s1A: View {
    ...
    static var initialDialogues: [DialogueItem] {
        [
            ...
            DialogueItem(
                text: "The room fell silent. Christina and Nick exchanged glances, then looked at Mark in unison, who was staring at his plate of carbonara, belying not a bit of his emotions. After a few moments, he looked up at me and, as if he had gathered his words, said,",
                speaker: "You"
            ),
            DialogueItem(
                text: "This is truly an altruistic act and there shouldn't be any reason on Earth that is against that.",
                speaker: "Mark"
            ),
            DialogueItem(
                text: "I gulped.",
            ...
            DialogueItem(
                text: "But, I have been thinking about it since you brought those leaflets about living donation home and asked me to read you all those articles about organ donation and calling for Dr Evans for an appointment without telling us and…",
                speaker: "Mark"
            ),
            DialogueItem(
                text: "He broke, tears melting into the pasta.",
                speaker: "You"
            ),
            DialogueItem(
                text: "The liver surgery was risky and we're so grateful that you made it. But what happens if… if it doesn't work this time?",
                speaker: "Nick"
            ),
            DialogueItem(
